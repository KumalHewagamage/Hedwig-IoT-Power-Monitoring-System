...
// static bool spi_initialized = false; // Initialization guard
...
//     spi_initialized = true; // Mark as initialized
...
// //I have commented the below lines-Mihiran
...
// output = (response >> 8) | (response << 8); // reverse MSB and LSB
// return output;
